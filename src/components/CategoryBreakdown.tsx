    ...
    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg space-y-5">
      ...
      <div className="flex items-center justify-between border-b border-slate-800 pb-3">
        <div>
          ...
          <p className="text-xs text-slate-400">Live summary of site expenses by category</p>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
        ...
        <div className="bg-slate-850 border border-slate-800 rounded-xl p-3">
          <div className="flex items-center space-x-1.5 text-slate-400 mb-1">
            ...
            <span className="text-[11px] font-medium truncate">Site Food</span>
          </div>
          <span className="text-sm font-bold text-slate-100 block">SAR {categoryTotals.food.toFixed(2)}</span>
        </div>
        ...
        <div className="bg-slate-850 border border-slate-800 rounded-xl p-3">
          <div className="flex items-center space-x-1.5 text-slate-400 mb-1">
            ...
            <span className="text-[11px] font-medium truncate">Project Material</span>
          </div>
          <span className="text-sm font-bold text-slate-100 block">SAR {categoryTotals.material.toFixed(2)}</span>
        </div>
        ...
        <div className="bg-slate-850 border border-slate-800 rounded-xl p-3">
          <div className="flex items-center space-x-1.5 text-slate-400 mb-1">
            ...
            <span className="text-[11px] font-medium truncate">Online Parts</span>
          </div>
          <span className="text-sm font-bold text-slate-100 block">SAR {categoryTotals.onlineParts.toFixed(2)}</span>
        </div>
